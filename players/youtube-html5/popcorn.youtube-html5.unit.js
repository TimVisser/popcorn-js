asyncTest( "Player play, pause, autoplay", function() {
  ...
  pop2 = Popcorn.youtubehtml5( "#video7", "http://www.youtube.com/watch?v=nfGV32RNkhw" );
  ...
  pop3 = Popcorn.youtubehtml5( "#video8", "http://www.youtube.com/watch?v=nfGV32RNkhw&autoplay=0" );
  ...
  pop4 = Popcorn.youtubehtml5( "#video9", "http://www.youtube.com/watch?v=nfGV32RNkhw&autoplay=1" );
...
asyncTest( "Popcorn YouTube Plugin Url and Duration Tests", function() {
  ...
  var count = 0,
      expects = 3,
      popcorn = Popcorn.youtubehtml5( '#video2', 'http://www.youtube.com/watch?v=nfGV32RNkhw' );
...
asyncTest( "Popcorn YouTube Plugin Url Regex Test", function() {
  ...
  Popcorn.forEach( urlTests, function( value, key ) {
    ...
    var urlTest = urlTests[ key ],
        popcorn = Popcorn.youtubehtml5( "#video" + i++, urlTest.url );
...
asyncTest( "Controls and Annotations toggling", function() {
  ...
  var popcorn1 = Popcorn.youtubehtml5( "#video", "http://www.youtube.com/watch?v=nfGV32RNkhw" );
  ...
  popcorn1.listen( "loadeddata", function() {
    ...
    var popcorn2 = Popcorn.youtubehtml5( "#video", "http://www.youtube.com/watch?v=nfGV32RNkhw&controls=1&iv_load_policy=1" );
    popcorn2.listen( "loadeddata", function() {
      ...
      var popcorn3 = Popcorn.youtubehtml5( "#video", "http://www.youtube.com/watch?v=nfGV32RNkhw&controls=0&iv_load_policy=3" );
...
asyncTest( "Player height and width", function() {
  ...
  var popcorn1 = Popcorn.youtubehtml5( "#video4", "http://www.youtube.com/watch?v=nfGV32RNkhw" ),
      popcorn2 = Popcorn.youtubehtml5( "#video5", "http://www.youtube.com/watch?v=nfGV32RNkhw" ),
...
asyncTest( "Popcorn Youtube Plugin offsetHeight && offsetWidth Test", function() {
  ...
  popped = Popcorn.youtubehtml5( "#video6", "http://www.youtube.com/watch?v=nfGV32RNkhw" );
...
asyncTest( "youtube player gets a proper _teardown", function() {
  ...
  var popcorn = Popcorn.youtubehtml5( "#video9", "http://www.youtube.com/watch?v=nfGV32RNkhw" );
  popcorn.listen( "loadeddata", function() {
